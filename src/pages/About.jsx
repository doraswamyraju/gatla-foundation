    ...
    <div className="pt-10">
      ...
      <section className="py-20 bg-[#0B1120] relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Layout changed to 3 columns on large screens (lg) */}
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            
            {/* 1. Left Side: Philosophy Box */}
            <div className="w-full lg:w-auto flex justify-center flex-none">
               <div className="relative w-64 h-80 bg-[#0F172A] border border-slate-700 flex flex-col items-center justify-center p-8 text-center shadow-2xl shrink-0">
            ...
            <div className="w-full lg:flex-1 text-center lg:text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                 {['Skill Development', 'Financial Inclusion', 'Social Dignity', 'Global Exposure'].map((item, i) => (
                   <div key={i} className="flex items-center justify-center lg:justify-start gap-2 text-slate-300 text-sm">
            ...
            {/* 3. Right Side: Founders Image with Hover Effect */}
            <div className="w-full lg:w-1/3 flex justify-center">
               <div className="relative group overflow-hidden rounded-lg border border-slate-700 shadow-2xl">
                  {/* Hover Overlay */}
                  ...
                  <img 
                    ...
                    alt="Founders" 
                    className="w-full h-auto object-cover transform group-hover:scale-110 transition-transform duration-700 ease-in-out grayscale-[20%] group-hover:grayscale-0" 
                  />
                  
                  {/* Optional: Caption on Hover */}
                  <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 to-transparent translate-y-full group-hover:translate-y-0 transition-transform duration-500 z-20">
                    <p className="text-white text-sm font-serif text-center">Visionary Leadership</p>
                  </div>
               </div>
            </div>
