                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <select name="disabilityCategory" onChange={handleChange} className="bg-slate-900 border border-slate-700 text-slate-300 p-3 rounded-lg focus:border-amber-500 outline-none">
                            ...
                            <option value="Normal Category">Normal Category</option>
                            <option value="Visually Impaired Category">Visually Impaired Category</option>
                            <option value="Deaf & Dumb Category">Deaf & Dumb Category</option>
                            <option value="Physically Handicapped Category">Physically Handicapped Category</option>
                            <option value="Wheel Chair Category">Wheel Chair Category</option>
                        </select>
                    </div>
