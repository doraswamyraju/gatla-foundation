            ...
            <div className="bg-slate-900/50 p-4 rounded-lg border border-amber-500/30">
              ...
              <div className="flex gap-6">
                <label className="flex items-center gap-2 text-white cursor-pointer">
                  <input type="radio" name="clubPreference" value="Education Club" checked={formData.clubPreference === 'Education Club'} onChange={handleChange} className="accent-amber-500 w-4 h-4" /> Education Club
                </label>
                <label className="flex items-center gap-2 text-white cursor-pointer">
                  <input type="radio" name="clubPreference" value="Cricket Club" checked={formData.clubPreference === 'Cricket Club'} onChange={handleChange} className="accent-amber-500 w-4 h-4" /> Cricket Club
                </label>
              </div>
            </div>
