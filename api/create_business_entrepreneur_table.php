<?php
// api/create_business_entrepreneur_table.php
...
$sql = "CREATE TABLE IF NOT EXISTS business_entrepreneurs (
...
if ($conn->query($sql) === TRUE) {
    echo json_encode(["status" => "success", "message" => "Table business_entrepreneurs created successfully"]);
} else {
