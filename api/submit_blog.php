...
// 2. Parse Form Data
// Note: When sending FormData with files, $_POST is populated automatically.
// If sending purely JSON without files, we would use file_get_contents('php://input').
// Since we likely use FormData for image upload support:
